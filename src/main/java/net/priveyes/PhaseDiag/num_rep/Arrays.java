...
public final class Arrays
{
	...
	public static Object getMany(Object array, Object indices)
	{
		...
		if (indicesClass == Integer.class)
			return java.lang.reflect.Array.get(array, (Integer) indices);
	...
	{
		int n = index.length;
		for (int anIndex : index) array = Array.get(array, anIndex);
		return array;
	} // getOne
	                                            ...
	                                            Object item)
	{
		...
		{
			int n = array.length;
			int newN = (Math.max((n + 1), (n * 3 / 2)));
			Object[] newArray = (Object[]) java.lang.reflect.Array.newInstance(array.getClass().getComponentType(), newN);
	...
	public static int subarrayLength(Object array,
	                                 int start, int n,
	                                 int depth, boolean[] which) // XXX should take an arbitrary array, use if it's the right level, otherwise index into it when recursing
	{
	...
	public static int getDimExtent(Object array)
	{
		...
		for (int i = 0; (i) < (n); ++i)
		{
			...
			maxComponentDim = (Math.max((maxComponentDim), (componentDim)));
		}
	...
	private static Object _makeArrayOfIndices(Object array, int depth, int[] currentIndex)
	{
		...
		else
		{
			...
			Object[] inds = (Object[]) java.lang.reflect.Array.newInstance(Arrays.getClassOfArrayOf(int[].class, depth - 1), arrayLength);
	...
	public static Object removeNulls(Object[] oldArray)
	{
		...
		for (Object anOldArray : oldArray)
			if (anOldArray != null) nNew++;
		...
		for (Object oldItem : oldArray) {
			if (oldItem != null) newArray[iNew++] = oldItem;
		}
		return newArray;
	} // removeNulls
	...
	public static Object flatten(Object array,
	                             int startDepth,
	                             int furtherDepth, boolean[] which)
	{
	...
	public static String toString(Object array, String[][] preSepSuf,
	                              int indexIntoPSS)
	{
		if (array == null)
			return "null";
			...
			extends java.text.Format
	{
				...
				throws java.text.ParseException
		{
			 ...
			 */
			Class primType = (s.contains("true") ? boolean.class : // XXX should ignore case
					s.contains("false") ? boolean.class : // XXX should ignore case
							s.contains(".") ? double.class : s.contains("E") ? double.class : s.contains("e") ? double.class : s.contains("f") ? float.class : s.contains("F") ? float.class :

									s.contains("'") ? char.class : int.class);
	...
	public static void main(String[] args)
	{
		if (true)
		{
			...
			Integer thisOne = 1;
			Integer thatOne = 1;
			System.out.println("thisZero == thatZero" + " = " + (thisZero.equals(thatZero)));
			System.out.println("thisZero == thatOne" + " = " + (thisZero.equals(thatOne)));
		...
		if (true)
		{
			double[][][] a = {{{0, 1},}, {{6, 5, 4, 3},}, {}, {{6, 5, 4, 3}, {0}, {},},};
		...
		if (true)
		{
			int[][][] a = {{{1, 2, 3}, {4, 5, 6},}, null, {null, {7, 8, 9}, null, null, {}, null,}, {},};
